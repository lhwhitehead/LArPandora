...
namespace lar_pandora{
   ...
   private:
    ...
    inline void DUNEFarDetVDThreeView::LoadDaughterDetectorGaps(const LArDriftVolume &driftVolume, const float maxDisplacement, LArDetectorGapList &listOfGaps) const
    {
        return;
    }
